...
export default async function AdsPage() {
    ...
    const contentFlexibleAd = ads?.find((a: Ad) => a.position === "content_flexible");
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="grid gap-8">
                ...
                <div className="col-span-1 md:col-span-2">
                    <h2 className="text-lg font-semibold mb-4">Content Flexible Banner (970x90 - 970x300 | Default 970x256)</h2>
                    <AdsForm position="content_flexible" initialData={contentFlexibleAd} previewMaxWidth="100%" />
                </div>
